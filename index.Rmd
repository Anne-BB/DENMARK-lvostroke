...
denmarkstrokepdf$strokenum<-str_replace(denmarkstrokepdf$X3, "[0-9]*","")%>% str_replace("/","\\")
...
###UPS first st_sf transform or crs?###
mapview(DemoStroke)

library(tmap)
tmap_mode("view")
DemoStroke<-mutate(DemoStroke)
tm_shape(DemoStroke, name= "Strokes inDK kommuner 2018")+tm_polygons("stroke_DK_2018", id="Strokenum", popup.vars=c("Cases"="stroke_DK_2018"), alpha=0.6)

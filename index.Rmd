...
mapview(Kommuner)
#View(Kommuner)
if(file.exists("DemoKom.Rda")){load("DemoKom.Rda")} else {
DemoKom<-select(Kommuner, starts_with("KOM"), starts_with("geometry"))
save(DemoKom, file = "DemoKom.Rda")}

##join DemoKom (demografic) with denmarkstroke (strokedensity)
if(file.exists("DemoStroke.Rda")){load("DemoStroke.Rda")} else {
DemoStroke<-right_join(denmarkstrokepdf, DemoKom, by=c("Uoplyst" = "KOMNAVN"))
